...
const Report = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0f172a] font-sans text-gray-100 pb-32 pt-20 md:pt-0 relative overflow-x-hidden overflow-y-hidden">
      {/* ===================================================================================== */}
      ...
      >
        ...
        <div className="flex justify-between items-start border-b-2 border-slate-700 pb-6 mb-8">
          ...
          <div className="text-right">
            <h2 className="text-lg font-bold text-blue-400">ManagementSyzen</h2>
        ...
        <div className="mt-12 border-t border-slate-700 pt-4 text-center">
          <p className="text-xs text-slate-500">Generated by ManagementSyzen App • {new Date().getFullYear()}</p>
        </div>
      </div>
      {/* --- END HIDDEN TEMPLATE --- */}
